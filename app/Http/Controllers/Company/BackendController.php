...
class BackendController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $company_employee = DB::table('cpn_company_employee')->where('user_id', $user_id)->first();
        ...
        $company = DB::table('cpn_company')
            ->where('create_company_employee_id', $company_employee->company_employee_id)
            ->first();
